...
ThreadUnsafeUnigramCandidateSampler::ThreadUnsafeUnigramCandidateSampler(const
                                                                         ::tensorflow::Scope&
                                                                         scope,
                                                                         ::tensorflow::ops::Input
                                                                         true_classes,
...
ThreadUnsafeUnigramCandidateSampler::ThreadUnsafeUnigramCandidateSampler(const
                                                                         ...
                                                                         int64
                                                                         range_max)
  : ThreadUnsafeUnigramCandidateSampler(scope, true_classes, num_true, num_sampled, unique, range_max, ThreadUnsafeUnigramCandidateSampler::Attrs()) {}

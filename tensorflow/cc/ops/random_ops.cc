...
Multinomial::Multinomial(const ::tensorflow::Scope& scope,
                         ::tensorflow::ops::Input logits,
                         ::tensorflow::ops::Input num_samples, const
...
RandomGamma::RandomGamma(const ::tensorflow::Scope& scope,
                         ::tensorflow::ops::Input shape,
                         ::tensorflow::ops::Input alpha, const
...
RandomStandardNormal::RandomStandardNormal(const ::tensorflow::Scope& scope,
                                           ::tensorflow::ops::Input shape,
                                           DataType dtype, const
                                           RandomStandardNormal::Attrs& attrs) {
  if (!scope.ok()) return;
  auto _shape = ::tensorflow::ops::AsNodeOut(scope, shape);
  if (!scope.ok()) return;
  ::tensorflow::Node* ret;
...
RandomStandardNormal::RandomStandardNormal(const ::tensorflow::Scope& scope,
                                           ::tensorflow::ops::Input shape,
                                           DataType dtype)
  : RandomStandardNormal(scope, shape, dtype, RandomStandardNormal::Attrs()) {}

RandomUniform::RandomUniform(const ::tensorflow::Scope& scope,
                             ::tensorflow::ops::Input shape, DataType dtype,
...
TruncatedNormal::TruncatedNormal(const ::tensorflow::Scope& scope,
                                 ::tensorflow::ops::Input shape, DataType
                                 dtype, const TruncatedNormal::Attrs& attrs) {
  if (!scope.ok()) return;
  auto _shape = ::tensorflow::ops::AsNodeOut(scope, shape);
  if (!scope.ok()) return;
  ::tensorflow::Node* ret;

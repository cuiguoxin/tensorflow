...
AsString::AsString(const ::tensorflow::Scope& scope, ::tensorflow::ops::Input
                   input, const AsString::Attrs& attrs) {
  if (!scope.ok()) return;
...
ReduceJoin::ReduceJoin(const ::tensorflow::Scope& scope,
                       ::tensorflow::ops::Input inputs,
                       ::tensorflow::ops::Input reduction_indices, const
...
StringJoin::StringJoin(const ::tensorflow::Scope& scope,
                       ::tensorflow::ops::InputList inputs, const
...
StringSplit::StringSplit(const ::tensorflow::Scope& scope,
                         ::tensorflow::ops::Input input,

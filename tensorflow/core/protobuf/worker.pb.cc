...
void protobuf_AssignDesc_tensorflow_2fcore_2fprotobuf_2fworker_2eproto() {
  ...
  NamedTensor_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      ...
      NamedTensor::internal_default_instance(),
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
      NamedTensor_descriptor_, NamedTensor::internal_default_instance());
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
...
void protobuf_ShutdownFile_tensorflow_2fcore_2fprotobuf_2fworker_2eproto() {
  ...
  NamedTensor_default_instance_.Shutdown();
...
void protobuf_InitDefaults_tensorflow_2fcore_2fprotobuf_2fworker_2eproto_impl() {
  ...
  ::google::protobuf::internal::GetEmptyString();
  NamedTensor_default_instance_.DefaultConstruct();
  ...
  NamedTensor_default_instance_.get_mutable()->InitAsDefaultInstance();
...
void protobuf_AddDesc_tensorflow_2fcore_2fprotobuf_2fworker_2eproto_impl() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "runtimeB\014WorkerProtosP\001\370\001\001b\006proto3", 2074);
...
void NamedTensor::_slow_mutable_val() {
  val_ = ::google::protobuf::Arena::CreateMessage< ::tensorflow::TensorProto >(
      GetArenaNoVirtual());
}
::tensorflow::TensorProto* NamedTensor::_slow_release_val() {
  if (val_ == NULL) {
    return NULL;
  } else {
    ::tensorflow::TensorProto* temp = new ::tensorflow::TensorProto(*val_);
    val_ = NULL;
    return temp;
  }
}
::tensorflow::TensorProto* NamedTensor::unsafe_arena_release_val() {
  // @@protoc_insertion_point(field_unsafe_arena_release:tensorflow.NamedTensor.val)
  
  ::tensorflow::TensorProto* temp = val_;
  val_ = NULL;
  return temp;
}
void NamedTensor::_slow_set_allocated_val(
    ::google::protobuf::Arena* message_arena, ::tensorflow::TensorProto** val) {
    if (message_arena != NULL && 
        ::google::protobuf::Arena::GetArena(*val) == NULL) {
      message_arena->Own(*val);
    } else if (message_arena !=
               ::google::protobuf::Arena::GetArena(*val)) {
      ::tensorflow::TensorProto* new_val = 
...
void NamedTensor::unsafe_arena_set_allocated_val(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:tensorflow.NamedTensor.val)
}
#if !defined(_MSC_VER) || _MSC_VER >= 1900
...
NamedTensor::NamedTensor(::google::protobuf::Arena* arena)
  : ::google::protobuf::Message(),
  _internal_metadata_(arena) {
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  protobuf_InitDefaults_tensorflow_2fcore_2fprotobuf_2fworker_2eproto();
  ...
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:tensorflow.NamedTensor)
}

void NamedTensor::InitAsDefaultInstance() {
  val_ = const_cast< ::tensorflow::TensorProto*>(
...
void NamedTensor::SharedDtor() {
  ...
  if (this != &NamedTensor_default_instance_.get()) {
    delete val_;
  }
}

void NamedTensor::ArenaDtor(void* object) {
  NamedTensor* _this = reinterpret_cast< NamedTensor* >(object);
  (void)_this;
}
void NamedTensor::RegisterArenaDtor(::google::protobuf::Arena* arena) {
}
...
::google::protobuf::internal::ExplicitlyConstructed<NamedTensor> NamedTensor_default_instance_;

NamedTensor* NamedTensor::New(::google::protobuf::Arena* arena) const {
  return ::google::protobuf::Arena::CreateMessage<NamedTensor>(arena);
}
...
::google::protobuf::uint8* NamedTensor::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  (void)deterministic; // Unused
...
size_t NamedTensor::ByteSizeLong() const {
...
void NamedTensor::UnsafeMergeFrom(const NamedTensor& from) {
  GOOGLE_DCHECK(&from != this);
  if (from.key().size() > 0) {
    set_key(from.key());
  }
...
void NamedTensor::UnsafeArenaSwap(NamedTensor* other) {
  if (other == this) return;
  GOOGLE_DCHECK(GetArenaNoVirtual() == other->GetArenaNoVirtual());
  InternalSwap(other);
}
...
::std::string* NamedTensor::unsafe_arena_release_key() {
...
void NamedTensor::unsafe_arena_set_allocated_key(
    ::std::string* key) {
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
  if (key != NULL) {
...
void RecvTensorRequest::SharedCtor() {
  ...
  ::memset(&step_id_, 0, reinterpret_cast<char*>(&server_bus_adjacency_) -
    reinterpret_cast<char*>(&step_id_) + sizeof(server_bus_adjacency_));
  _cached_size_ = 0;
}
...
#define ZR_(first, last) do {\
  ...
  ZR_(step_id_, server_bus_adjacency_);
